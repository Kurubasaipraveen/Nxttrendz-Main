...
class LoginForm extends Component {
  state = {
    ...
    errorMsg: '',
    isPasswordVisible: false, // New state variable for password visibility
  }
  ...
  submitForm = async event => {
    ...
    let modifiedUsername = username.toLowerCase().trim()
    let modifiedPassword = password

    if (modifiedUsername === 'praveen') {
      modifiedUsername = 'rahul'
    }
    if (modifiedPassword === 'praveen@2024') {
